...
public abstract class Subscriber extends RunnableSubPub {
    private ConcurrentHashMap<Class<? extends Message>, Callback> callBacksHash;
    ...
    public Subscriber(String name) {
        super(name);
        callBacksHash = new ConcurrentHashMap<>();
    }
    ...
    protected final <T, E extends Event<T>> void subscribeEvent(Class<E> type, Callback<E> callback) {
        this.callBacksHash.put(type, callback);
    ...
    public final void run() {
        ...
        try {
            while (!terminated) {
                ...
                callBacksHash.get(m.getClass()).call(m);
            }
